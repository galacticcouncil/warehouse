...
fn update_global_farm_should_work() {
    let testing_values = vec![
        (
            ...
            Balance::from(2_501_944_769_u128),
            FixedU128::from_inner(259_000_000_000_000_000_000_u128),
            HDX,
            BSX_FARM,
            Balance::from(0_u128),
            BlockNumber::from(206_u64),
            Balance::from(65_192_006_u128),
            Balance::from(55_563_662_u128),
            FixedU128::from_inner(259_000_000_000_000_000_000_u128),
            Balance::from(55_563_662_u128),
        ),
        (
            BlockNumber::from(188_u64),
            Balance::from(33_769_603_u128),
            FixedU128::from_inner(1_148_000_000_000_000_000_000_u128),
            BSX,
            ACA_FARM,
            Balance::from(30_080_406_306_u128),
            BlockNumber::from(259_u64),
            Balance::from(1_548_635_u128),
            Balance::from(56_710_169_u128),
            FixedU128::from_inner(1_151_255_978_016_679_674_913_u128),
            Balance::from(166_663_254_u128),
        ),
        (
            BlockNumber::from(195_u64),
            Balance::from(26_098_384_286_056_u128),
            FixedU128::from_inner(523_000_000_000_000_000_000_u128),
            ACA,
            KSM_FARM,
            Balance::from(32_055_u128),
            BlockNumber::from(326_u64),
            Balance::from(1_712_797_u128),
            Balance::from(61_424_428_u128),
            FixedU128::from_inner(523_000_000_001_228_236_953_u128),
            Balance::from(61_456_483_u128),
        ),
        (
            BlockNumber::from(181_u64),
            Balance::from(9_894_090_144_u128),
            FixedU128::from_inner(317_000_000_000_000_000_000_u128),
            KSM,
            ACA_FARM,
            Balance::from(36_806_694_280_u128),
            BlockNumber::from(1856_u64),
            Balance::from(19_009_156_u128),
            Balance::from(52_711_084_u128),
            FixedU128::from_inner(320_218_116_657_175_263_350_u128),
            Balance::from(31_893_047_384_u128),
        ),
        (
            BlockNumber::from(196_u64),
            Balance::from(26_886_423_482_043_u128),
            FixedU128::from_inner(596_000_000_000_000_000_000_u128),
            ACA,
            ACA_FARM,
            Balance::from(30_560_755_872_u128),
            BlockNumber::from(954_u64),
            Balance::from(78_355_u128),
            Balance::from(34_013_971_u128),
            FixedU128::from_inner(596_000_002_209_036_469_267_u128),
            Balance::from(93_407_061_u128),
        ),
        (
            BlockNumber::from(68_u64),
            Balance::from(1_138_057_342_u128),
            FixedU128::from_inner(4_000_000_000_000_000_000_u128),
            ACA,
            ACA_FARM,
            Balance::from(38_398_062_768_u128),
            BlockNumber::from(161_u64),
            Balance::from(55_309_798_233_u128),
            Balance::from(71_071_995_u128),
            FixedU128::from_inner(37_740_007_072_508_302_485_u128),
            Balance::from(38_469_134_763_u128),
        ),
        (
            BlockNumber::from(161_u64),
            Balance::from(24_495_534_649_923_u128),
            FixedU128::from_inner(213_000_000_000_000_000_000_u128),
            KSM,
            ACA_FARM,
            Balance::from(11_116_735_745_u128),
            BlockNumber::from(448_u64),
            Balance::from(326_u128),
            Balance::from(85_963_452_u128),
            FixedU128::from_inner(213_000_000_003_819_553_291_u128),
            Balance::from(86_057_014_u128),
        ),
        (
            BlockNumber::from(27_u64),
            Balance::from(22_108_444_u128),
            FixedU128::from_inner(970_000_000_000_000_000_000_u128),
            KSM,
            ACA_FARM,
            Balance::from(8_572_779_460_u128),
            BlockNumber::from(132_u64),
            Balance::from(1_874_081_u128),
            Balance::from(43_974_403_u128),
            FixedU128::from_inner(97_890_060_399_546_888_0577_u128),
            Balance::from(240_752_908_u128),
        ),
        (
            BlockNumber::from(97_u64),
            Balance::from(1_593_208_u128),
            FixedU128::from_inner(6_000_000_000_000_000_000_u128),
            HDX,
            BSX_FARM,
            Balance::from(18_440_792_496_u128),
            BlockNumber::from(146_u64),
            Balance::from(741_803_u128),
            Balance::from(14_437_690_u128),
            FixedU128::from_inner(28_814_564_702_160_672_052_u128),
            Balance::from(50_786_037_u128),
        ),
        (
            BlockNumber::from(154_u64),
            Balance::from(27_279_119_649_838_u128),
            FixedU128::from_inner(713_000_000_000_000_000_000_u128),
            BSX,
            KSM_FARM,
            Balance::from(28_318_566_664_u128),
            BlockNumber::from(202_u64),
            Balance::from(508_869_u128),
            Balance::from(7_533_987_u128),
            FixedU128::from_inner(713_000_000_895_399_569_837_u128),
            Balance::from(31_959_699_u128),
        ),
        (
            BlockNumber::from(104_u64),
            Balance::from(20_462_312_838_954_u128),
            FixedU128::from_inner(833_000_000_000_000_000_000_u128),
            BSX,
            ACA_FARM,
            Balance::from(3_852_003_u128),
            BlockNumber::from(131_u64),
            Balance::from(1_081_636_u128),
            Balance::from(75_149_021_u128),
            FixedU128::from_inner(833_000_000_188_248_661_347_u128),
            Balance::from(79_001_024_u128),
        ),
        (
            BlockNumber::from(90_u64),
            Balance::from(37_650_830_596_054_u128),
            FixedU128::from_inner(586_000_000_000_000_000_000_u128),
            HDX,
            ACA_FARM,
            Balance::from(27_990_338_179_u128),
            BlockNumber::from(110_u64),
            Balance::from(758_482_u128),
            Balance::from(36_765_518_u128),
            FixedU128::from_inner(586_000_000_402_903_196_552_u128),
            Balance::from(51_935_158_u128),
        ),
        (
            BlockNumber::from(198_u64),
            Balance::from(318_777_215_u128),
            FixedU128::from_inner(251_000_000_000_000_000_000_u128),
            ACA,
            ACA_FARM,
            Balance::from(3_615_346_492_u128),
            BlockNumber::from(582_u64),
            Balance::from(69_329_u128),
            Balance::from(12_876_432_u128),
            FixedU128::from_inner(251_083_513_923_666_093_889_u128),
            Balance::from(39_498_768_u128),
        ),
        (
            BlockNumber::from(29_u64),
            Balance::from(33_478_250_u128),
            FixedU128::from_inner(77_000_000_000_000_000_000_u128),
            BSX,
            BSX_FARM,
            Balance::from(39_174_031_245_u128),
            BlockNumber::from(100_u64),
            Balance::from(1_845_620_u128),
            Balance::from(26_611_087_u128),
            FixedU128::from_inner(80_914_153_816_283_706_585_u128),
            Balance::from(157_650_107_u128),
        ),
        (
            BlockNumber::from(91_u64),
            Balance::from(393_922_835_172_u128),
            FixedU128::from_inner(2_491_000_000_000_000_000_000_u128),
            ACA,
            ACA_FARM,
            Balance::from(63_486_975_129_400_u128),
            BlockNumber::from(260_u64),
            Balance::from(109_118_678_233_u128),
            Balance::from(85_100_506_u128),
            FixedU128::from_inner(2_537_813_880_726_983_020_710_u128),
            Balance::from(18_441_141_721_883_u128),
        ),
        (
            BlockNumber::from(67_u64),
            Balance::from(11_26_422_u128),
            FixedU128::from_inner(295_000_000_000_000_000_000_u128),
            HDX,
            BSX_FARM,
            Balance::from(7_492_177_402_u128),
            BlockNumber::from(229_u64),
            Balance::from(1_227_791_u128),
            Balance::from(35_844_776_u128),
            FixedU128::from_inner(471_578_708_512_440_275_491_u128),
            Balance::from(234_746_918_u128),
        ),
        (
            BlockNumber::from(168_u64),
            Balance::from(28_351_324_279_041_u128),
            FixedU128::from_inner(450_000_000_000_000_000_000_u128),
            ACA,
            BSX_FARM,
            Balance::from(38_796_364_068_u128),
            BlockNumber::from(361_u64),
            Balance::from(1_015_284_u128),
            Balance::from(35_695_723_u128),
            FixedU128::from_inner(450_000_006_911_487_099_206_u128),
            Balance::from(231_645_535_u128),
        ),
        (
            BlockNumber::from(3_u64),
            Balance::from(17_631_376_575_792_u128),
            FixedU128::from_inner(082_000_000_000_000_000_000_u128),
            HDX,
            ACA_FARM,
            Balance::from(20_473_946_880_u128),
            BlockNumber::from(52_u64),
            Balance::from(1_836_345_u128),
            Balance::from(93_293_564_u128),
            FixedU128::from_inner(82_000_005_103_453_188_308_u128),
            Balance::from(183_274_469_u128),
        ),
        (
            BlockNumber::from(49_u64),
            Balance::from(94_059_u128),
            FixedU128::from_inner(81_000_000_000_000_000_000_u128),
            HDX,
            KSM_FARM,
            Balance::from(11_126_653_978_u128),
            BlockNumber::from(132_u64),
            Balance::from(1_672_829_u128),
            Balance::from(75_841_904_u128),
            FixedU128::from_inner(1_557_145_897_787_558_872_622_u128),
            Balance::from(214_686_711_u128),
        ),
        (
            BlockNumber::from(38_u64),
            Balance::from(14_085_u128),
            FixedU128::from_inner(266_000_000_000_000_000_000_u128),
            KSM,
            KSM_FARM,
            Balance::from(36_115_448_964_u128),
            BlockNumber::from(400000_u64),
            Balance::from(886_865_u128),
            Balance::from(52_402_278_u128),
            FixedU128::from_inner(2_564_373_132_694_355_697_550_585_u128),
            Balance::from(36_167_851_242_u128),
        ),
        (
            BlockNumber::from(158_u64),
            Balance::from(762_784_u128),
            FixedU128::from_inner(129_000_000_000_000_000_000_u128),
            BSX,
            KSM_FARM,
            Balance::from(21_814_882_774_u128),
            BlockNumber::from(158_u64),
            Balance::from(789_730_u128),
            Balance::from(86_085_676_u128),
            FixedU128::from_inner(129_000_000_000_000_000_000_u128),
            Balance::from(86_085_676_u128),
        ),
    ];
    ...
    ) in testing_values.iter()
    {
        ...
        global_farm.accumulated_rpz = FixedU128::from(*accumulated_rpz);
