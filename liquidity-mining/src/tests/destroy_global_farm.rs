...
fn destroy_global_farm_should_work() {
    ...
    predefined_test_ext().execute_with(|| {
        ...
        let bob_reward_currency_balance = Tokens::free_balance(PREDEFINED_GLOBAL_FARMS_INS1[1].reward_currency, &BOB);
        let undistributed_rewards =
            Tokens::free_balance(PREDEFINED_GLOBAL_FARMS_INS1[1].reward_currency, &farm_account);
        ...
        assert_eq!(
            Tokens::free_balance(PREDEFINED_GLOBAL_FARMS_INS1[1].reward_currency, &BOB),
    ...
    predefined_test_ext().execute_with(|| {
        ...
        let charlie_reward_currency_balance =
            Tokens::free_balance(PREDEFINED_GLOBAL_FARMS_INS1[3].reward_currency, &CHARLIE);
        let undistributed_rewards =
            Tokens::free_balance(PREDEFINED_GLOBAL_FARMS_INS1[3].reward_currency, &farm_account);
        ...
        assert_eq!(
            ...
            GlobalFarmData {
                ...
                ..PREDEFINED_GLOBAL_FARMS_INS1[3]
            }
        );
...
fn destroy_global_farm_not_owner_should_not_work() {
    predefined_test_ext().execute_with(|| {
        ...
        assert_eq!(
            ...
            PREDEFINED_GLOBAL_FARMS_INS1[1]
        );
    });
}
...
fn destroy_global_farm_healthy_farm_should_not_work() {
    predefined_test_ext().execute_with(|| {
        ...
        assert!(!Tokens::free_balance(PREDEFINED_GLOBAL_FARMS_INS1[2].reward_currency, &farm_account).is_zero());
        ...
        assert_eq!(
            ...
            PREDEFINED_GLOBAL_FARMS_INS1[2]
        );
    });
}
