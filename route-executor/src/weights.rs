...
impl<T: frame_system::Config> WeightInfo for BasiliskWeight<T> {
    fn sell(n: u32) -> Weight {
        (21_829_000 as Weight) // Standard Error: 150_000
            .saturating_add((79_362_000 as Weight).saturating_mul(n as Weight))
    ...
    fn buy(n: u32) -> Weight {
        (19_398_000 as Weight) // Standard Error: 125_000
            .saturating_add((79_117_000 as Weight).saturating_mul(n as Weight))
            .saturating_add(T::DbWeight::get().reads(4 as Weight))
            .saturating_add(T::DbWeight::get().reads((8 as Weight).saturating_mul(n as Weight)))
            .saturating_add(T::DbWeight::get().writes(2 as Weight))
            .saturating_add(T::DbWeight::get().writes((3 as Weight).saturating_mul(n as Weight)))
